...
for i in Label:
    ...
    c += 1
print(Label_dict)
train_dir = r'/home/zhai/PycharmProjects/Demo35/dataset/voc/VOCdevkit/VOC2012/JPEGImages/'
names = os.listdir(train_dir)
names = [name.split('.')[0] for name in names]
names = sorted(names)
ann_path = '/home/zhai/PycharmProjects/Demo35/dataset/voc/VOCdevkit/VOC2012/Annotations/'
c = 0
img_paths = []
Bboxes = []
# np.random.seed(50)
