...
if __name__ == "__main__":
    ...
    model = resnet101
    config = Config(False, Mean, None, img_max=1000, img_min=600)
    model_file = '/home/zhai/PycharmProjects/Demo35/pytorch_object_detection/train_one_GPU/models/Faster_101_90000_1.pth'
